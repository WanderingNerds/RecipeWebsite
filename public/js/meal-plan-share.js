/**
 * Meal plan share link (REW-69)
 *
 * Copy-to-clipboard for the share URL on the meal plan detail page. Loaded as
...
document.addEventListener('DOMContentLoaded', function () {
  const panel = document.querySelector('[data-meal-plan-share]');
  if (!panel) return;

  const urlInput = panel.querySelector('[data-meal-plan-share-url]');
  const copyButton = panel.querySelector('[data-meal-plan-share-copy]');
  const feedback = panel.querySelector('[data-meal-plan-share-feedback]');
